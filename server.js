...
// ── CORRIGIDO: Handler 404 para rotas /api/* inexistentes ─────
// Evita que o SPA fallback retorne HTML quando a rota da API não existe,
// o que causaria erros de "Unexpected token '<'" no frontend ao parsear JSON.
