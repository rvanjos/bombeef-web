...
const TABELAS_POR_MODULO = {
  ...
  financeiro: [
    ...
    'dre_sessoes','dre_lancamentos','dre_fechamentos','dre_fechamento_eventos','dre_fluxo_saldo_controle','dre_fluxo_conferencias','dre_planejamento_anual','cartao_faturas','cartao_fatura_itens','cartao_apelido_mapa',
