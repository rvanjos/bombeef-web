(function(){
  ...
  function tags(){
    return '<link rel="stylesheet" href="/css/dre-v2.css?v=3" data-dre-v2="1">' +
      ...
      '<script src="/js/dre-fechamento.js?v=1" data-dre-fechamento="1"><\/script>';
  }
          ...
          var p=document.createElement('script'); p.src='/js/dre-cartao-pagamentos.js?v=1'; p.dataset.dreCartaoPag='1'; p.onload=function(){
            var q=document.createElement('script'); q.src='/js/dre-conferencia-v2.js?v=1'; q.dataset.dreConfV2='1'; q.onload=function(){
              var a=document.createElement('script'); a.src='/js/dre-lancamentos-area.js?v=2'; a.dataset.dreLancArea='1'; a.onload=function(){
                var f=document.createElement('script'); f.src='/js/dre-fechamento.js?v=1'; f.dataset.dreFechamento='1'; document.head.appendChild(f);
