 ...
 *   1. req.user.id → req.usuario.id em 3 locais (bulk DELETE e INSERTs)
 */
...
module.exports = function (pool) {
  ...
  r.post('/bulk', async (req, res) => {
    ...
    try {
      ...
      `, [req.usuario.id]); // ← CORRIGIDO: req.usuario.id
  ...
  r.post('/', async (req, res) => {
    ...
    try {
      ...
      `, [
        ...
        b.status || 'avencer', b.obs || null, b.origem || 'manual', req.usuario.id, // ← CORRIGIDO
      ]);
